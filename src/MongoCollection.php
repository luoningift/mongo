...
class MongoCollection
{
    ...
    public function batchInsert(array &$documents, array $options = [])
    {
        ...
        $this->client->opInsert($this->fqn, $documents, $options, $timeout);
